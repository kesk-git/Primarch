...
- `skills/` - public, installer-facing skills meant to be installed standalone into any project, independent of firstmate.
  Today that is `skills/firstmate-notes` and `skills/stow`; each names what it needs and how to use it in its own `SKILL.md`, which is the one owner of that contract.
