...
[`configuration.md`](configuration.md#gate-defaults-no-mistakesyaml) owns the firstmate repo's own gate defaults, including where its test evidence is stored.
