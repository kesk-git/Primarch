...
One gate response closes the whole gate: every finding you do not name in it is closed unfixed, so name every finding you are fixing, escalating, or treating as a no-op.
